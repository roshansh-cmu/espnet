...
train_set="train_subset_50_seg20"
...
./asr_av.sh                                        \
    ...
    --asr_args "--use_wandb true --wandb_project how2_asilomar --wandb_name av_resnext_subset_hierattn_novat_seg20" \
    --asr_stats_dir exp/asr_av_stats_subset_seg20_${video_feats_type} \
