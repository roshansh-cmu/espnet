...
asr_config=conf/train_asr_av_tf_r2plus1d_fbank_hierattn.yaml
...
./asr_av.sh                                        \
    ...
    --asr_args "--use_wandb true --wandb_project how2_asilomar --wandb_name av_conf_subset_r2plus1d_hierattn" \
