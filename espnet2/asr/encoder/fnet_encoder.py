...
class FNetConformerEncoder(AbsEncoder):
    """FNet-Conformer encoder module.
    ...
    def __init__(
        ...
        if pos_enc_layer_type == "abs_pos":
            ...
            assert selfattention_layer_type == "fnet_selfattn"
        ...
        if selfattention_layer_type == "fnet_selfattn":
